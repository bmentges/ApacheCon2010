// Some customizations made by HOSS (see svn log for details)...
// - iframe 'expand' class support
...
function fontScale() {  // causes layout problems in FireFox that get fixed if browser's Reload is used; same may be true of other Gecko-based browsers
  ...
  // iframe expansion
  var iframes = GetElementsWithClassName("iframe", "expand"); 
  for (var i=0; i < iframes.length; i++) {
    iframes[i].style.width = (0.75 * hSize) + "px";
    iframes[i].style.height = (0.75 * vSize) + "px";
  } 
